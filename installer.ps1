...
<Window x:Class="WpfApp2.MainWindow"
        ...
        mc:Ignorable="d"
        Title="Microsoft Íntallation Tool - www.msgang.com" Height="515" Width="970" ResizeMode="NoResize" WindowStartupLocation="CenterScreen" Icon="https://filedn.com/lOX1R8Sv7vhpEG9Q77kMbn0/MSGANG/PowerShell/images/msgang_microsoft_icon.png">
    <Grid HorizontalAlignment="Left" VerticalAlignment="Top">
        <GroupBox x:Name="groupBoxMicrosoftOffice" Header="Select version to install:" BorderBrush="#FF164A69" Margin="125,10,0,0" HorizontalAlignment="Left" VerticalAlignment="Top" Height="458" Width="821" FontFamily="Consolas" FontSize="11">
            <Canvas HorizontalAlignment="Left" VerticalAlignment="Top">
                ...
                <RadioButton x:Name="radioButton2019Outlook" Content="Outlook" VerticalContentAlignment="Center" IsChecked="False" Padding="5,5,5,5" Canvas.Left="335" Canvas.Top="214" HorizontalAlignment="Left" VerticalAlignment="Top"/>
                ...
                <RadioButton x:Name="radioButton2016Outlook" Content="Outlook" VerticalContentAlignment="Center" IsChecked="False" Padding="5,5,5,5" Canvas.Top="214" Canvas.Left="503" HorizontalAlignment="Center" VerticalAlignment="Top"/>
                ...
                <TextBox x:Name="textbox1" TextWrapping="Wrap" Text="(*) By default, this script installs Office 64-bit English." Canvas.Top="338" FontSize="10.5" BorderBrush="{x:Null}" Background="{x:Null}" HorizontalAlignment="Center" VerticalAlignment="Top" Canvas.Left="-3" Margin="2,5,0,2" Padding="0,0,0,2"/>
                <TextBox x:Name="textbox2" TextWrapping="Wrap" Text="(*) Default mode is Install. If you want to download only, select Download mode." Canvas.Top="361" FontSize="10.5" BorderBrush="{x:Null}" Background="{x:Null}" HorizontalAlignment="Left" VerticalAlignment="Top" Canvas.Left="-3" Padding="0,0,0,2" Margin="2,5,0,2"/>
                <TextBox x:Name="textbox3" TextWrapping="Wrap" Text="(*) The downloaded files would be saved on the current user's desktop." Canvas.Top="382" FontSize="10.5" BorderBrush="{x:Null}" Background="{x:Null}" HorizontalAlignment="Left" VerticalAlignment="Top" Canvas.Left="-3" Padding="0,0,0,2" Margin="2,5,0,2"/>
                <TextBox x:Name="textbox4" TextWrapping="Wrap" Text="(*) More FREE Microsoft products, please visit:" Canvas.Top="405" FontSize="10.5" BorderBrush="{x:Null}" Background="{x:Null}" Canvas.Left="-3" HorizontalAlignment="Center" VerticalAlignment="Top" Padding="0,0,0,2" Margin="2,5,0,0"/>
        ...
        <GroupBox x:Name="groupBoxMode" Header="LicenseType" Margin="10,164,0,0" BorderBrush="#FF0D4261" HorizontalAlignment="Left" VerticalAlignment="Top" FontFamily="Consolas" FontSize="11" Width="104" Height="67" ToolTip="When selecting the Activate mode...">
            <StackPanel HorizontalAlignment="Left" VerticalAlignment="Top">
                ...
                <RadioButton x:Name="RadioButtonInstall" Content="Install" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="5,5,0,0" VerticalContentAlignment="Center" IsChecked="True"/>
            </StackPanel>
        </GroupBox>
        <GroupBox x:Name="groupBoxLanguage" Header="Language" Margin="10,239,0,0" BorderBrush="#FF0D4261" HorizontalAlignment="Left" VerticalAlignment="Top" FontFamily="Consolas" FontSize="11" Width="104" Height="229">
            <StackPanel HorizontalAlignment="Left" VerticalAlignment="Top">
                ...
                <RadioButton x:Name="radioButtonIndonesian" VerticalContentAlignment="Center" Margin="5,6,0,0" Content="Indonesian"/>
        ...
        <Label x:Name="Link1" HorizontalAlignment="Left" Margin="405,429,0,0" VerticalAlignment="Top" Width="120" FontSize='10.5' ToolTip='vmware' FontFamily="Consolas" Padding="5,5,5,2">
