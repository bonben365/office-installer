...
<Window x:Class="installRetail.MainWindow"
        ...
        mc:Ignorable="d"
        Title="Microsoft Installation Tool (Retail Version) - www.bonguides.com" Height="515" Width="970" WindowStartupLocation="CenterScreen" Icon="https://filedn.com/lOX1R8Sv7vhpEG9Q77kMbn0/MSGANG/PowerShell/images/msgang_microsoft_icon.png" Topmost="True">
